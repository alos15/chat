...
<body style="background-color: #0a192d;">
    <div class="chat">
        <div class="button-email">
            <span> <?=$user?> </span>
            <a href="deconnexion.php" class="Deconnexion_btn" style="background-color: green;">Déconnexion</a>
        </div>
        <!-- messages -->
        ...
        <form action= "" class="send_message" method="POST">
             <textarea name="message" cols="30" rows="2" placeholder="Votre message" style="border: 2px solid green;"></textarea>
             <input type="submit" value="Envoyer" name="send" style="background-color: green;border: 2px solid green;">
        </form>
    </div>
